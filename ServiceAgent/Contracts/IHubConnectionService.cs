...
namespace ServiceAgent.Contracts
{
    public interface IHubConnectionService : IDisposable, IHostedService
    {
        ...
        IAsyncEnumerable<T> GetAllAsync<T>(string methodName, object? arg = null);
        IAsyncEnumerable<T> GetAllLiveAsync<T>(string methodName, Action<T> handler, object? arg = null);
